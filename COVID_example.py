...
"""
Created on Sat Sep 30 00:40:47 2023

@author: gs
"""

# Read and analyze daily COVID data from Italian regions in June 2020.
...
def AveragePlot(D):
    """ Takes as input a dictionary with a key for each region and, 
        as values, the corresponding daily average of new cases. 
        Creates plot of different regions and their corresponding daily average 
...
if __name__ == "__main__":
    ...
    # Read one file 
    print("===>>> Read one file, test if it worked correctly:")
    ...
    # Read multiple files
    print("===>>> Read multiple files, test if it worked correctly:")
    ...
    # Create plot of daily averages of new cases
    print("===>>> See plot of daily averages of new cases per region")
    AveragePlot(Bs)
    
    # Create timeline per region & attribute
    print("===>>> See timeline of given attribute per region")
    TimelinePlot(As, attr='ICU')
    TimelinePlot(As, region='Emilia-Romagna', attr='ICU')
    
    # Create timeline of all regions per attribute
